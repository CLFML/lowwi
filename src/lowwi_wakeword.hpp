...
public:
   ...
   * @param min_acivations Number of activations the model should have to be
...
>>>>>>> main
   ...
   * @param features Reference to vector containing the features prepared with
   * embedding model
   * @return wakeword_result struct with average confidence factor and detected
   * flag
   */
